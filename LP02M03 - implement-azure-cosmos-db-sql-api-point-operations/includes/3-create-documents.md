...
In this example below, we handle a conflict scenario where the item already exists in the container and fall back to a general exception handling block for other scenarios:
